...
::: tip 场景
原作者git远程仓库更新了，我本地仓库需要同步作者远程仓库更新
...
- 如果之前已经添加过名为 upstream 的远程源，请跳过步骤1
- 实际分支名称可能是 master 而非 main ，请根据仓库实际情况替换
- 建议在合并前使用 git status 确认当前分支状态
- 推荐使用 git pull --rebase upstream/main 代替步骤3中的普通合并，可以保持提交历史更整洁
  :::

## 同步分支

- 将本地master分支同步到最新dev分支，可以执行以下步骤：
