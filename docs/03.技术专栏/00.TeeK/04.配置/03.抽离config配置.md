...
- 在`docs\.vitepress\config`文件夹中创建`FooterInfo.ts`文件
...
export const FooterInfo = {
  ...
  customHtml: `<p style="margin: 0; display: inline;">小破站已运行了 <span id="footer-runtime"></span></p>`, // 搭配 ./theme/helper/useFooterRuntime.ts
};
```
