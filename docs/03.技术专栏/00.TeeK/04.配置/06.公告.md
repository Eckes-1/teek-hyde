  ...
  <div v-if="visible" class="notice">
    ...
    <div class="notice-describe">
      ...
      <p class="notice-domain">
        <strong>
          详细教程：
          <a href="https://vitepress.yiov.top/layout.html#%E5%85%AC%E5%91%8A" target="_blank">vitepress.yiov.top</a>
        </strong>
      </p>
      <p>QQ 频道：******(无效二维码)</p>
...
<template>
  <div v-if="visible" class="bulletin-wrapper" style="width: 300px;">
    ...
    <div class="bulletin-content">
      ...
      <p class="bulletin-p">
        公告样式，参考自
        <a class="bulletin-link" href="https://theme-reco.vuejs.press/" target="_blank">VuePress-Reco</a>
      </p>
