...
- 配置命令
  ...
  2. **your_user_name_in_github**: 这是您在 GitHub 上的用户名，通常是您注册时使用的名称。例如，如果您的 GitHub 用户名是 `Seasir-Eckes`，那么这里您应该填 `Seasir-Eckes`。
  ...
  ```bash
  D:\code\imageUploader_windows_amd64.exe -token=替换您实际的your_token -owner=Seasir-Eckes -repo=typora_image_uploader
  ```
...
![image-20241103025718494](https://raw.githubusercontent.com/Seasir-Eckes/typora_image_uploader/main/image/1730573838_0.png)
