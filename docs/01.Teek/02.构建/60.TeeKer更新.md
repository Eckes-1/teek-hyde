...
vitepress-theme-Teek-hyde     https://gitee.com/SeasirEckes/vitepress-theme-Teek-hyde.git (fetch)
vitepress-theme-Teek-hyde     https://gitee.com/SeasirEckes/vitepress-theme-Teek-hyde.git (push)
```
