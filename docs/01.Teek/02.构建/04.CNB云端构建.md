...
```bash
git init .
git remote add origin https://cnb.cool/W3C/Eckes/teek-hyde.git
git config --local user.name SeasirEckes
  ...
  push:
    - runner:
      ...
      services:
        - docker
        - git-clone-yyds
    - imports: https://cnb.cool/W3C/Eckes/secret/-/blob/main/env.yml
      settings:
      ...
      stages:
        ...
        - name: sync to gitee
          ...
          settings:
            ...
            target_url: https://gitee.com/SeasirEckes/teek-hyde.git
