...
onMounted(async () => {
    ...
    menus: {
      items: [
        ...
        },
        {
          ...
          title: "gitee",
          onClick: () => {
            window.open("https://gitee.com/SeasirEckes/teek-hyde");
          },
        },
        {
          id: "toggleDock",
  ...
  oml2d.onStageSlideIn(() => {
    ...
    oml2d.statusBarPopup("要像路飞一样，永远对自己喜欢的事保持热爱！", oml2d.options.primaryColor); // 使用配置的主色调

    oml2d.stopTipsIdle(); //停止空闲消息播放器

    oml2d.tipsMessage(`欢迎访问Eckes·栗辉，当前版本:${oml2d.version}`, 5000, 10);
  });
