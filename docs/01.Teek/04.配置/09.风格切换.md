...
import { Features } from "../../ConfigEckes/Features"; // 导入Features模块
import { FriendLink } from "../../ConfigEckes/FriendLink"; // 导入FriendLink模块
import { HitokotoDate } from "../../ConfigEckes/HitokotoDate"; // 导入HitokotoData模块
import { SocialDate } from "../../ConfigEckes/SocialDate"; // 导入SocialDate社交信息模块
import { Wallpaper } from "../../ConfigEckes/Wallaper"; // 导入Wallaper模块
...
import { Nav } from "./ConfigEckes/Nav"; // 导入Nav模块
import type { HeadConfig } from "vitepress"; // 在文件顶部添加类型导入
import { HeadData } from "./ConfigEckes/Head"; // 导入 HeadData 导入和类型断言
import { SocialLinks } from "./ConfigEckes/SocialLinks"; //导入社交链接配置
import { FooterInfo } from "./ConfigEckes/FooterInfo"; //导入底部信息配置
import { CommentData } from "./ConfigEckes/Comment"; //导入底部信息配置
import { footerGroup } from "./ConfigEckes/footerGroup"; //导入页脚信息组配置
