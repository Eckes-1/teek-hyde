  ...
  <div class="my-links-container">
    ...
    <div v-if="bannerShow" class="flink-banner" id="banners">
      ...
      <div class="banners-small-title">
        <svg t="1761472824402" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6414" width="24" height="24">
          <path d="M704 128C833.621333 128 938.666667 234.666667 938.666667 384c0 298.666667-320 469.333333-426.666667 533.333333-84.394667-50.602667-302.250667-167.978667-389.589333-362.666666h200.405333l39.850667-66.389334 128 213.333334L578.816 554.666667H725.333333v-85.333334h-194.816l-39.850666 66.389334-128-213.333334L274.517333 469.333333H94.293333A407.552 407.552 0 0 1 85.333333 384c0-149.333333 106.666667-256 234.666667-256C399.36 128 469.333333 170.666667 512 213.333333c42.666667-42.666667 112.64-85.333333 192-85.333333z" fill="currentColor" p-id="6415"></path>
        </svg>
        {{ smallTitle }}
      </div>
      ...
      <div class="message-card">
        ...
        <div class="copy-button-container">
          <button class="copy-button" @click="copyMessageFormat" :aria-label="copyButtonText">
            <svg t="1761473315965" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12400" width="16" height="16">
              <path d="M480 0h248.2C753.6 0 778 10.2 796 28.2L931.8 164c18 18 28.2 42.4 28.2 67.8V672c0 53-43 96-96 96H480c-53 0-96-43-96-96V96c0-53 43-96 96-96zM160 256h160v128H192v512h384v-64h128v96c0 53-43 96-96 96H160c-53 0-96-43-96-96V352c0-53 43-96 96-96z" fill="currentColor" p-id="12401"></path>
            </svg>
